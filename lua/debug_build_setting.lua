...
local function debug_build()
   ...
   if ext == "c" or filename == "CMakeLists.txt" or ext=="cpp"then
      ...
      if util.isQtProject() then
         vim.cmd('!cmake -S . -B build -G Ninja -DCMAKE_BUILD_TYPE=Debug -DCMAKE_C_COMPILER=cl.exe -DCMAKE_CXX_COMPILER=cl.exe -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_PREFIX_PATH="C:/Qt/6.9.0/mingw_64/lib/cmake"')
      else
